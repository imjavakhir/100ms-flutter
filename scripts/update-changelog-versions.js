...
function updateChangelogVersions() {
  const changelogPath = path.join(
    __dirname,
    "../packages/hmssdk_flutter/example/ExampleAppChangelog.txt"
  );
  ...
  try {
    ...
    // This matches from "Current Version Info:" to the end of the file
    const regex = /Current Version Info:[\s\S]*$/;
